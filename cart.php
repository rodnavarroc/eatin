...
<body style="font-family: Epilogue; background-color: #f2f2f2; color: #2E1F27;">
	...
	<div class="container"  style="padding-top: 100px;">
		<p style="font-family: News Cycle; padding: 5px 10px; font-size: 20px; background-color: #F4C95D; color: #854D27; border-radius: 7px;"><i class="fas fa-shopping-cart"></i>&nbsp;Tu pedido</p>
